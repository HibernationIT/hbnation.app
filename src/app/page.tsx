  ...
  return (
    <>
      ...
      <main className="flex flex-col items-center justify-between pt-18">
        <section className="flex flex-col relative w-full h-[calc(100vh-72px)] bg-main-image bg-repeat bg-center bg-cover">
          <div className="flex flex-col justify-center items-center w-full h-full bg-[rgba(255,255,255,0.15)] dark:bg-[rgba(0,0,0,0.15)]">
            <div className="w-full max-w-screen-xl px-8">
              <div className="flex flex-row items-center gap-4 mb-8">
                <svg
                  className="w-9 md:w-16 h-9 md:h-16 fill-white"
              ...
              <div className="text-xl md:text-2xl text-white mb-16">
                ...
                {(Object.keys(tags) as Array<keyof typeof tags>).map(
                  (tag, key) => (
                    <a
                      href={tags[tag]}
                      key={key.toString()}
                      className="px-3 md:px-4 py-1 md:py-1.5 text-sm md:text-base text-white border border-white rounded-full transition-colors hover:bg-[rgba(255,255,255,0.5)]"
                    >
                      {tag}
                    </a>
                  )
